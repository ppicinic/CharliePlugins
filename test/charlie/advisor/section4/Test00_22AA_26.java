...
/**
 * First test in for section 4 your hand: 2,2-A,A their hand: 2-6
 * @author Gregory Cremins, Phil Picnic 
 * @version 2-19-2014
 * 
 */
public class Test00_22AA_26 {
    ...
    public void test()
    {
        try{
            ...
            hand.hit(new Card(1, CLUBS));
            hand.hit(new Card(1, HEARTS));
            Card upCard = new Card(3, DIAMONDS);
