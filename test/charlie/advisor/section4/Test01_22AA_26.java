...
/**
 * Second test in for section 4 your hand: 2,2-A,A their hand: 2-6
 * @author Gregory Cremins, Phil Picnic 
 * @version 2-19-2014
 * 
 */
public class Test01_22AA_26 {
    ...
    public void test()
    {
        try{
            ...
            hand.hit(new Card(7, SPADES));
            hand.hit(new Card(7, DIAMONDS));
            Card upCard = new Card(5, CLUBS);
            Play play = new BasicStrategy().advise(hand, upCard);
            assertTrue(play == Play.SPLIT);
        }
        catch(Exception e)
        {
